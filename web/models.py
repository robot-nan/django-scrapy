...
class GoldPivotPoint(BaseTime):
    ...
    support1 = models.CharField(u'支撑位1', max_length=32, null=True, blank=True)
    support2 = models.CharField(u'支撑位2', max_length=32, null=True, blank=True)
    support3 = models.CharField(u'支撑位3', max_length=32, null=True, blank=True)
    Pivot = models.CharField(u'轴点', max_length=32, null=True, blank=True)
    drag1 = models.CharField(u'阻力位1', max_length=32, null=True, blank=True)
    drag2 = models.CharField(u'阻力位2', max_length=32, null=True, blank=True)
    drag3 = models.CharField(u'阻力位3', max_length=32, null=True, blank=True)
    show_data = models.CharField(u'更新区间', max_length=2, choices=GlOD_SHOW_TIME_CHOICE, default=u'0')


class GoldName(models.Model):
    """枢轴点 名称"""
    name = models.CharField(u'名称', max_length=32, null=True, blank=True)


class GoldTechniqueData(BaseTime):
    """技术指标"""
    symbol = models.ForeignKey('GoldName', related_name='gold_technique_data')
    get_time = models.CharField(u'官方更新时间', max_length=32, null=True, blank=True)
    price = models.CharField(u'价值', max_length=32, null=True, blank=True)
    oprate = models.CharField(u'操作', max_length=32, null=True, blank=True)
    show_data = models.CharField(u'更新区间', max_length=2, choices=GlOD_SHOW_TIME_CHOICE, default=u'0')


class GoldSymbolName(models.Model):
    """技术指标 符号名 名字会变 如果没有要的名字就要重新写入进去"""
    name = models.CharField(u'符号名称', max_length=32, null=True, blank=True)
...
class GoldMoveAverage(BaseTime):
    ...
    standard = models.CharField(u'标准', max_length=32, null=True, blank=True)
    move = models.CharField(u'移动', max_length=32, null=True, blank=True)
    show_data = models.CharField(u'更新区间', max_length=2, choices=GlOD_SHOW_TIME_CHOICE, default=u'0')
